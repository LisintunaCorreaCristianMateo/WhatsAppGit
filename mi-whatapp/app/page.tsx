...
type Mensaje = { id: string; texto: string; origen: 'CLIENTE' | 'SISTEMA'; creadoEn: string; estado?: string };
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              {mensajes.map((msg) => (
                <div key={msg.id} className={`flex ${msg.origen === 'SISTEMA' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`px-4 py-2 rounded-lg max-w-md shadow flex flex-col ${
